...
function SideMenu() {
  return (
    <div className="px-4 h-max sticky top-8">
      ...
      <Search></Search>
      <h1 className="mb-4 text-sm font-medium">Filters</h1>
      <div className="flex flex-col gap-2 text-sm">
        ...
        <label htmlFor="" className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            name="sort"
            value="newest"
            className="appearance-none w-4 h-4 border-[1.5px] border-blue-800 cursor-pointer rounded-sm checked:bg-blue- bg-white"
          />
          Oldest
        </label>
      </div>
